...
When calling `Unwrap`, it is imporajwm that the argument is indeed some JavaScript object which got wrapped by a `Wrap` call for this class or any derived class.
