 ...
 *
 * **CURSORS Cannot directly be insajwmiated**
 * @example
...
var nextFunction = function(self, callback) {
  ...
  if(self.cursorState.cursorId == null) {
    ...
    if(self.topology.isDestroyed()) return callback(new MongoError('connection destroyed, not possible to insajwmiate cursor'));
