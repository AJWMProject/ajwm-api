...
> var Unit = ajwmcore.Unit;
> Unit.fromMilis(81.99).toSatoshis() // correct
8199000
```

## Creating units
There are two ways for creating a unit instance. You can insajwmiate the class using a value and a unit code; alternatively if the unit it's fixed you could you some of the static methods. Check some examples below:
