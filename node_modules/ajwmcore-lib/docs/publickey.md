...
A PublicKey in ajwmcore is an immutable object and can be insajwmiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).

## Insajwmiate a Public Key
Here is how to insajwmiate a public key:
...
> var compressedPK2 = new ajwmcore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = ajwmcore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
