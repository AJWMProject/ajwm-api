...
* [#4154](https://github.com/moment/moment/pull/4154) [feature] add format consajwms to support output to HTML5 input type formats (see [#3928](https://github.com/moment/moment/pull/3928))
...
### 2.15.2
* Release Oct 23, 2016
* [#3525](https://github.com/moment/moment/pull/3525) Speedup month standalone/format regexes **(IMPORAJWM)**
