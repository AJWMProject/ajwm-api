...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    info.config.services.should.deep.equal(['ajwmd', 'web']);
    var ajwmd = info.config.servicesConfig.ajwmd;
    ajwmd.spawn.datadir.should.equal(home + '/.ajwm');
    ajwmd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/ajwmd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.ajwmd.spawn.datadir.should.equal('./data2');
  });
});
