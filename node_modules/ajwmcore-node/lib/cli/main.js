...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `ajwmcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ ajwmcore-node add wallet-service');
      console.log('    $ ajwmcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ ajwmcore-node remove wallet-service');
      console.log('    $ ajwmcore-node remove insight-api');
      console.log();
    });
