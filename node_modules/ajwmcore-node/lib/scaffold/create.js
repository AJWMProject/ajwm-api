...
var BASE_PACKAGE = {
  ...
  dependencies: {
    ...
    'ajwmcore-lib': 'https://github.com/ajwmproject/ajwmcore-lib.git#master',
    'ajwmcore-node': 'https://github.com/ajwmproject/ajwmcore-node.git#master'
  }
};
...
function createConfigDirectory(options, configDir, isGlobal, done) {
  mkdirp(configDir, function(err) {
    ...
    try {
      fs.writeFileSync(configDir + '/ajwmcore-node.json', configJSON);
      if (!isGlobal) {
...
function create(options, done) {
  ...
  async.series([
    function(next) {
      // Setup the the ajwmcore-node directory and configuration
