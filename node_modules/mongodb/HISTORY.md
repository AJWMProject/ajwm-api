...
* MongoClient only has the connect method (no ability insajwmiate with Server, ReplSet or similar)
* Removed Grid class
...
* Made PingStrategy api more consisajwm, callback to start/stop methods are optional (Issue #693, https://github.com/aheckmann)
...
--------------------
* Fixed up documentation to reflect the preferred way of insajwmiating bson types
