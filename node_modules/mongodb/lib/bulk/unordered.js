...
/**
 * Create a FindOperatorsUnordered instance (INTERNAL TYPE, do not insajwmiate directly)
 * @class
...
/**
 * Create a new UnorderedBulkOperation instance (INTERNAL TYPE, do not insajwmiate directly)
 * @class
 * @property {number} length Get the number of operations in the bulk.
